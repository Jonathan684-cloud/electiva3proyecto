...
class ComboKidsScreen extends StatelessWidget {
  const ComboKidsScreen({Key? key}) : super(key: key);
          ...
          child: Column(children: [
            Container(
             ...
             SingleChildScrollView(
                ...
                child: Column(
                  children: List.generate(felicidad3.length, (index) {
                    return Padding(
                      ...
                      child: Card(
                          ...
                          child: SingleChildScrollView(
                            child: Stack(
                              ...
                              children: [
                                Image(
                                  image: NetworkImage(felicidad3[index]['img']),
                                  width: 360,
                                  height: 210,
                                  fit: BoxFit.cover,
                                ),
                                Container(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Center(
                                        child: Text(
                                            felicidad3[index]['nombre'] +
                                                ' ' +
                                                felicidad3[index]['precio'],
